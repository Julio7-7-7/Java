...
public class inventario extends javax.swing.JPanel {
    ...
    public inventario() {
        initComponents();
        cargarUnidadMedida();
    //    jcInsumoinve = new JComboBox<>();  // Iniciar el JComboBox
    }
    ...
    JComboBox<String> jcombox = jcInsumoinve;  // Suponiendo que `jComboBox1` es el JComboBox en el panel inventario
    jcInsumoinve.removeAllItems();  // Limpiar elementos previos

    for (String idInsumo : idsInsumos) {
        jcInsumoinve.addItem(idInsumo);  // Agregar cada ID al JComboBox
    }
}
...
private String obtenerUnidadMedidaSeleccionada() {
    ...
    void setjComboBox1(ArrayList<String> idsInsumos) {
